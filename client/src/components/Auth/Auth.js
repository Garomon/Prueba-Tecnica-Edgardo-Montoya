  ...
  return (
    <Container component="main" maxWidth="xs">
      <Paper className={classes.paper} elevation={6}>
        ...
        <Typography component="h1" variant="h5">{isSignup ? 'Regístrate' : 'Ingresar'}</Typography>
          ...
          <Grid container justify="flex-end">
            <Grid item>
              <Button onClick={switchMode}>
                {isSignup ? 'Ya tienes cuenta? Ingresa aquí' : "No tienes cuenta? Regístrate aquí"}
              </Button>
            </Grid>
          </Grid>
        </form>
